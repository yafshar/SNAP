...
public:
  ...
  inline Array3DView<DataType> const data_3D(int i) const;
  inline Array3DView<DataType> data_3D(int i);

  inline Array2DView<DataType> const data_2D(int i, int j) const;
  inline Array2DView<DataType> data_2D(int i, int j);

  inline Array1DView<DataType> const data_1D(int i, int j, int k) const;
...
public:
  ...
  inline Array4DView<DataType> const data_4D(int i) const;
  inline Array4DView<DataType> data_4D(int i);

  inline Array3DView<DataType> const data_3D(int i, int j) const;
  inline Array3DView<DataType> data_3D(int i, int j);

  inline Array2DView<DataType> const data_2D(int i, int j, int k) const;
  inline Array2DView<DataType> data_2D(int i, int j, int k);

  inline Array1DView<DataType> const data_1D(int i, int j, int k, int l) const;
...
template <class DataType>
inline Array2DView<DataType> const Array3DView<DataType>::data_2D(int i) const
{
...
template <class DataType>
inline Array1DView<DataType> const Array3DView<DataType>::data_1D(int i, int j) const
{
...
template <class DataType>
Array3DView<DataType>::j_operator::j_operator(Array3DView<DataType> &_array, int i) : j_array(_array),
                                                                                      _i(i) {}

template <class DataType>
Array3DView<DataType>::j_operator::k_operator::k_operator(Array3DView<DataType> &_array, int i, int j) : k_array(_array),
                                                                                                         _i(i),
                                                                                                         _j(j) {}

template <class DataType>
DataType const Array3DView<DataType>::j_operator::k_operator::operator[](int k) const
{
...
template <class DataType>
const typename Array3DView<DataType>::j_operator::k_operator Array3DView<DataType>::j_operator::operator[](int j) const
{
  return k_operator(j_array, _i, j);
}

template <class DataType>
typename Array3DView<DataType>::j_operator::k_operator Array3DView<DataType>::j_operator::operator[](int j)
{
  return k_operator(j_array, _i, j);
}

template <class DataType>
const typename Array3DView<DataType>::j_operator Array3DView<DataType>::operator[](int i) const
{
  return j_operator(*this, i);
}

template <class DataType>
typename Array3DView<DataType>::j_operator Array3DView<DataType>::operator[](int i)
{
  return j_operator(*this, i);
}
...
template <class DataType>
inline Array3DView<DataType> const Array4DView<DataType>::data_3D(int i) const
{
...
template <class DataType>
inline Array2DView<DataType> const Array4DView<DataType>::data_2D(int i, int j) const
{
...
template <class DataType>
inline Array1DView<DataType> const Array4DView<DataType>::data_1D(int i, int j, int k) const
{
...
template <class DataType>
Array4DView<DataType>::j_operator::j_operator(Array4DView<DataType> &_array, int i) : j_array(_array),
                                                                                      _i(i) {}

template <class DataType>
Array4DView<DataType>::j_operator::k_operator::k_operator(Array4DView<DataType> &_array, int i, int j) : k_array(_array),
                                                                                                         _i(i),
                                                                                                         _j(j) {}

template <class DataType>
Array4DView<DataType>::j_operator::k_operator::l_operator::l_operator(Array4DView<DataType> &_array, int i, int j, int k) : l_array(_array),
                                                                                                                            _i(i),
                                                                                                                            _j(j),
                                                                                                                            _k(k) {}
...
template <class DataType>
typename Array4DView<DataType>::j_operator::k_operator::l_operator Array4DView<DataType>::j_operator::k_operator::operator[](int k)
{
  return l_operator(k_array, _i, _j, k);
}

template <class DataType>
const typename Array4DView<DataType>::j_operator::k_operator Array4DView<DataType>::j_operator::operator[](int j) const
{
  return k_operator(j_array, _i, j);
}

template <class DataType>
typename Array4DView<DataType>::j_operator::k_operator Array4DView<DataType>::j_operator::operator[](int j)
{
  return k_operator(j_array, _i, j);
}

template <class DataType>
const typename Array4DView<DataType>::j_operator Array4DView<DataType>::operator[](int i) const
{
  return j_operator(*this, i);
}

template <class DataType>
typename Array4DView<DataType>::j_operator Array4DView<DataType>::operator[](int i)
{
  return j_operator(*this, i);
}
...
template <class DataType>
inline Array3DView<DataType> const Array4D<DataType>::data_3D(int i) const
{
  std::size_t const _n = i * _extentOne * _extentTwo * _extentThree;
...
template <class DataType>
inline Array2DView<DataType> const Array4D<DataType>::data_2D(int i, int j) const
{
  std::size_t const _n = (i * _extentOne + j) * _extentTwo * _extentThree;
...
template <class DataType>
inline Array1DView<DataType> const Array4D<DataType>::data_1D(int i, int j, int k) const
{
  std::size_t const _n = ((i * _extentOne + j) * _extentTwo + k) * _extentThree;
...
template <class DataType>
Array4D<DataType>::j_operator::k_operator::k_operator(Array4D<DataType> &_array, int i, int j) : k_array(_array),
                                                                                                 _i(i),
                                                                                                 _j(j) {}

template <class DataType>
Array4D<DataType>::j_operator::k_operator::l_operator::l_operator(Array4D<DataType> &_array, int i, int j, int k) : l_array(_array),
                                                                                                                    _i(i),
                                                                                                                    _j(j),
                                                                                                                    _k(k) {}

template <class DataType>
DataType const Array4D<DataType>::j_operator::k_operator::l_operator::operator[](int l) const
{
  std::size_t const _n = ((_i * l_array._extentOne + _j) * l_array._extentTwo + _k) * l_array._extentThree + l;
  return l_array.m[_n];
}
...
template <class DataType>
const typename Array4D<DataType>::j_operator::k_operator::l_operator Array4D<DataType>::j_operator::k_operator::operator[](int k) const
{
  return l_operator(k_array, _i, _j, k);
}

template <class DataType>
typename Array4D<DataType>::j_operator::k_operator::l_operator Array4D<DataType>::j_operator::k_operator::operator[](int k)
{
  return l_operator(k_array, _i, _j, k);
}

template <class DataType>
const typename Array4D<DataType>::j_operator::k_operator Array4D<DataType>::j_operator::operator[](int j) const
{
  return k_operator(j_array, _i, j);
}

template <class DataType>
typename Array4D<DataType>::j_operator::k_operator Array4D<DataType>::j_operator::operator[](int j)
{
  return k_operator(j_array, _i, j);
}

template <class DataType>
const typename Array4D<DataType>::j_operator Array4D<DataType>::operator[](int i) const
{
  return j_operator(*this, i);
}
...
template <class DataType>
inline Array4DView<DataType> const Array5D<DataType>::data_4D(int i) const
{
...
template <class DataType>
inline Array3DView<DataType> const Array5D<DataType>::data_3D(int i, int j) const
{
...
template <class DataType>
inline Array2DView<DataType> const Array5D<DataType>::data_2D(int i, int j, int k) const
{
...
template <class DataType>
inline Array1DView<DataType> const Array5D<DataType>::data_1D(int i, int j, int k, int l) const
{
...
template <class DataType>
Array5D<DataType>::j_operator::k_operator::k_operator(Array5D<DataType> &_array, int i, int j) : k_array(_array),
                                                                                                 _i(i),
                                                                                                 _j(j) {}

template <class DataType>
Array5D<DataType>::j_operator::k_operator::l_operator::l_operator(Array5D<DataType> &_array, int i, int j, int k) : l_array(_array),
                                                                                                                    _i(i),
                                                                                                                    _j(j),
                                                                                                                    _k(k) {}

template <class DataType>
Array5D<DataType>::j_operator::k_operator::l_operator::n_operator::n_operator(Array5D<DataType> &_array, int i, int j, int k, int l) : n_array(_array),
                                                                                                                                       _i(i),
                                                                                                                                       _j(j),
                                                                                                                                       _k(k),
                                                                                                                                       _l(l) {}
...
template <class DataType>
DataType const Array5D<DataType>::j_operator::k_operator::l_operator::n_operator::operator[](int n) const
{
...
template <class DataType>
const typename Array5D<DataType>::j_operator::k_operator::l_operator::n_operator Array5D<DataType>::j_operator::k_operator::l_operator::operator[](int l) const
{
  return n_operator(l_array, _i, _j, _k, l);
}

template <class DataType>
typename Array5D<DataType>::j_operator::k_operator::l_operator::n_operator Array5D<DataType>::j_operator::k_operator::l_operator::operator[](int l)
{
  return n_operator(l_array, _i, _j, _k, l);
}

template <class DataType>
const typename Array5D<DataType>::j_operator::k_operator::l_operator Array5D<DataType>::j_operator::k_operator::operator[](int k) const
{
  return l_operator(k_array, _i, _j, k);
}

template <class DataType>
typename Array5D<DataType>::j_operator::k_operator::l_operator Array5D<DataType>::j_operator::k_operator::operator[](int k)
{
  return l_operator(k_array, _i, _j, k);
}

template <class DataType>
const typename Array5D<DataType>::j_operator::k_operator Array5D<DataType>::j_operator::operator[](int j) const
{
  return k_operator(j_array, _i, j);
}

template <class DataType>
typename Array5D<DataType>::j_operator::k_operator Array5D<DataType>::j_operator::operator[](int j)
{
  return k_operator(j_array, _i, j);
}

template <class DataType>
const typename Array5D<DataType>::j_operator Array5D<DataType>::operator[](int i) const
{
  return j_operator(*this, i);
}
