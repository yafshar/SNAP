...
double ZBL::e_zbl(double const rij, int const iSpecies, int const jSpecies)
{
    ...
    double sum = ZBLConstants::c1 * std::exp(-d1aij * rij);
    sum += ZBLConstants::c2 * std::exp(-d2aij * rij);
    sum += ZBLConstants::c3 * std::exp(-d3aij * rij);
    sum += ZBLConstants::c4 * std::exp(-d4aij * rij);
...
double ZBL::dzbldr(double const rij, int const iSpecies, int const jSpecies)
{
    ...
    double sum = ZBLConstants::c1 * e1;
    sum += ZBLConstants::c2 * e2;
    sum += ZBLConstants::c3 * e3;
    sum += ZBLConstants::c4 * e4;

    double sum_p = -ZBLConstants::c1 * d1aij * e1;
    sum_p -= ZBLConstants::c2 * d2aij * e2;
    sum_p -= ZBLConstants::c3 * d3aij * e3;
    sum_p -= ZBLConstants::c4 * d4aij * e4;
...
double ZBL::d2zbldr2(double const rij, int const iSpecies, int const jSpecies)
{
    ...
    double sum_p = ZBLConstants::c1 * e1 * d1aij;
    sum_p += ZBLConstants::c2 * e2 * d2aij;
    sum_p += ZBLConstants::c3 * e3 * d3aij;
    sum_p += ZBLConstants::c4 * e4 * d4aij;

    double sum_pp = ZBLConstants::c1 * e1 * d1aij * d1aij;
    sum_pp += ZBLConstants::c2 * e2 * d2aij * d2aij;
    sum_pp += ZBLConstants::c3 * e3 * d3aij * d3aij;
    sum_pp += ZBLConstants::c4 * e4 * d4aij * d4aij;
